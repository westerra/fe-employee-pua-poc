...
export const APP_ACCESS_CONTROL_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_ACCESS_CONTROL_BASE_PATH');
export const APP_APPROVAL_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_APPROVAL_BASE_PATH');
export const APP_ARRANGEMENT_MANAGER_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_ARRANGEMENT_MANAGER_BASE_PATH');
export const APP_AUDIT_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_AUDIT_BASE_PATH');
export const APP_COMMENTS_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_COMMENTS_BASE_PATH');
export const APP_CONTACT_MANAGER_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_CONTACT_MANAGER_BASE_PATH');
export const APP_DEVICE_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_DEVICE_BASE_PATH');
export const APP_EMPLOYEE_ACTIONS_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_EMPLOYEE_ACTIONS_BASE_PATH');
export const APP_EMPLOYEE_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_EMPLOYEE_BASE_PATH');
export const APP_IMPERSONATION_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_IMPERSONATION_BASE_PATH');
...
export const APP_PAYMENT_ORDER_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_PAYMENT_ORDER_BASE_PATH');
export const APP_USER_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_USER_BASE_PATH');
export const APP_USER_PROFILE_BASE_PATH = new InjectionToken<string>('ServicePathsModule::APP_USER_PROFILE_BASE_PATH');
 ...
 * correctly applied.
 */
const dataModulePaths: [InjectionToken<string>, string][] = [[APP_ACCESS_CONTROL_BASE_PATH, '/access-control'],[APP_APPROVAL_BASE_PATH, '/approval-service'],[APP_ARRANGEMENT_MANAGER_BASE_PATH, '/arrangement-manager'],[APP_AUDIT_BASE_PATH, '/audit-service'],[APP_COMMENTS_BASE_PATH, '/comments'],[APP_CONTACT_MANAGER_BASE_PATH, '/contact-manager'],[APP_DEVICE_BASE_PATH, '/device-management-service'],[APP_EMPLOYEE_ACTIONS_BASE_PATH, '/employee-actions'],[APP_EMPLOYEE_BASE_PATH, '/employee'],[APP_IMPERSONATION_BASE_PATH, '/orchestration'],[APP_LIMIT_BASE_PATH, '/limit'],[APP_MESSAGES_BASE_PATH, '/messages-service'],
  [APP_NOTIFICATIONS_BASE_PATH, '/notifications-service'],[APP_PAYMENT_ORDER_BASE_PATH, '/payment-order-service'],[APP_USER_BASE_PATH, '/user-manager'], [APP_USER_PROFILE_BASE_PATH, '/user-profile-manager']
];
