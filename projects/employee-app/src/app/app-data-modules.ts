...
import { APP_ACCESS_CONTROL_BASE_PATH, APP_APPROVAL_BASE_PATH, APP_ARRANGEMENT_MANAGER_BASE_PATH, APP_AUDIT_BASE_PATH, APP_COMMENTS_BASE_PATH,APP_CONTACT_MANAGER_BASE_PATH, APP_DEVICE_BASE_PATH, APP_EMPLOYEE_ACTIONS_BASE_PATH, APP_IMPERSONATION_BASE_PATH, APP_LIMIT_BASE_PATH, APP_PAYMENT_ORDER_BASE_PATH, APP_USER_BASE_PATH, APP_USER_PROFILE_BASE_PATH} from './service-paths.module';
