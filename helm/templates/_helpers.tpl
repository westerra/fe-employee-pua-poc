...
{{ include "employee-app.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "employee-app.selectorLabels" -}}
...
*/}}
{{- define "employee-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "employee-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
